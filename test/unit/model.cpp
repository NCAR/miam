...
TEST(Model, SpeciesUsedWithNoProcesses)
{
    ...
    auto mode = miam::SingleMomentMode{ "MODE1", { aqueous_phase } };
...
TEST(Model, SpeciesUsedWithSingleRepresentationAndProcess)
{
    ...
    auto mode = miam::SingleMomentMode{ "SMALL_DROP", { aqueous_phase } };
    ...
    miam::DissolvedReversibleReaction reaction{
        forward_rate,
        reverse_rate,
        { h2o },      // reactants
        { hp, ohm },  // products
...
TEST(Model, SpeciesUsedWithMultipleRepresentations)
{
    ...
    auto small_drop = miam::SingleMomentMode{ "SMALL_DROP", { aqueous_phase } };
    auto large_drop = miam::SingleMomentMode{ "LARGE_DROP", { aqueous_phase } };
...
TEST(Model, SpeciesUsedWithMultipleProcesses)
{
    ...
    auto mode = miam::TwoMomentMode{ "AITKEN", { aqueous_phase } };
    ...
    miam::DissolvedReversibleReaction h2o_dissociation{
        h2o_forward,
        h2o_reverse,
        { h2o },
        { hp, ohm },
    ...
    miam::DissolvedReversibleReaction co2_hydration{
        co2_forward,
        co2_reverse,
        { co2, h2o },
        { h2co3 },
...
TEST(Model, SpeciesUsedMixedRepresentationTypes)
{
    ...
    auto mode1 = miam::SingleMomentMode{ "MODE1", { aqueous_phase } };
    auto mode2 = miam::TwoMomentMode{ "MODE2", { aqueous_phase } };
    auto section = miam::UniformSection{ "BIN_01", { aqueous_phase } };
...
TEST(Model, AddProcesses)
{
    ...
    miam::DissolvedReversibleReaction reaction1{
        forward_rate,
        reverse_rate,
        { h2o },
        { hp, ohm },
    ...
    miam::DissolvedReversibleReaction reaction2{
        reverse_rate,
        forward_rate,
        { hp, ohm },
        { h2o },
...
TEST(Model, CollectPhaseStatePrefixesValidation)
{
    ...
    auto mode1 = miam::SingleMomentMode{ "DUPLICATE", { aqueous_phase } };
    auto mode2 = miam::SingleMomentMode{ "DUPLICATE", { aqueous_phase } };
...
TEST(Model, SpeciesUsedWithDifferentPhasesInReactions)
{
    ...
    auto aqueous_mode = miam::SingleMomentMode{ "DROPLET", { aqueous_phase } };
    auto organic_mode = miam::UniformSection{ "PARTICLE", { organic_phase } };
    ...
    miam::DissolvedReversibleReaction aqueous_reaction{
        forward_rate,
        reverse_rate,
        { h2o },
        { hp },
