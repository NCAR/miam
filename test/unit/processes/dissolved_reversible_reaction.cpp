...
TEST(DissolvedReversibleReaction, JacobianFunctionMultipleReactantsProducts)
{
  ...
  // d[CO2]/d[H2O] = -k_f / [H2O] * [CO2] + k_f * (1-2) / [H2O]^2 * [CO2] * [H2O] = -k_f * [CO2] / [H2O] - k_f * [CO2] /
  // [H2O]
...
TEST(DissolvedReversibleReaction, JacobianFunctionTwoReactantsWithSolventDependence)
{
  ...
  double d_forward_rate_d_baz =
      -k_forward * state_variables[0][0] * state_variables[0][1] / std::pow(state_variables[0][3], 2);
...
TEST(DissolvedReversibleReaction, JacobianFDMultiCell)
{
  ...
  params[0][0] = k_forward;
  params[0][1] = k_reverse;
  params[1][0] = k_forward;
  params[1][1] = k_reverse;
  params[2][0] = k_forward;
  params[2][1] = k_reverse;
...
TEST(DissolvedReversibleReaction, JacobianFDMultipleInstances)
{
  ...
  svi["LARGE.AQUEOUS.H+"] = 1;
  svi["LARGE.AQUEOUS.OH-"] = 2;
  svi["SMALL.AQUEOUS.H2O"] = 3;
