...
TEST(AerosolPropertyProvider, ComputeValueAssignment)
{
  ...
  provider.ComputeValue =
      [&was_called](const MatrixPolicy& /* params */, const MatrixPolicy& /* vars */, MatrixPolicy& /* result */)
  { was_called = true; };
...
TEST(AerosolPropertyProvider, ComputeValueAndDerivativesAssignment)
{
  ...
  bool was_called = false;
  provider.ComputeValueAndDerivatives = [&was_called](
                                            const MatrixPolicy& /* params */,
                                            const MatrixPolicy& /* vars */,
                                            MatrixPolicy& /* result */,
                                            MatrixPolicy& /* partials */) { was_called = true; };
