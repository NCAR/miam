...
namespace
{
  ...
  CarbonicAcidSystem MakeCarbonicAcidSystem()
  {
    ...
    auto rxn1 = DissolvedReversibleReaction{ UserDefinedConstantExpression{ k1_f },
                                             UserDefinedConstantExpression{ k1_r },
                                             { CO2_aq },
                                             { Hp, HCO3m },
                                             H2O,
                                             aqueous_phase };
...
TEST(AqueousCarbonicAcid, KineticODE)
{
  ...
  auto rxn2 = DissolvedReversibleReaction{ UserDefinedConstantExpression{ k2_f },
                                           UserDefinedConstantExpression{ k2_r },
                                           { sys.HCO3m },
                                           { sys.Hp, sys.CO3mm },
                                           sys.H2O,
                                           sys.aqueous_phase };
  ...
  auto rxn_w = DissolvedReversibleReaction{ UserDefinedConstantExpression{ kw_f },
                                            UserDefinedConstantExpression{ kw_r },
                                            { sys.H2O },
                                            { sys.Hp, sys.OHm },
                                            sys.H2O,
                                            sys.aqueous_phase };
