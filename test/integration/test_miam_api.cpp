...
int main()
{
  ...
  // 20) (AEROSOL.) ACCUMULATION.AQUEOUS.CO2
  // 21) (AEROSOL.) ACCUMULATION.AQUEOUS.H2O
  // 22) (AEROSOL.) ACCUMULATION.AQUEOUS.OH-
  // 23) (AEROSOL.) ACCUMULATION.AQUEOUS.H+
  // 24) (AEROSOL.) ACCUMULATION.AQUEOUS.HCO3-
  // 25) (AEROSOL.) ACCUMULATION.AQUEOUS.CO32-
  // 26) (AEROSOL.) ACCUMULATION.ORGANIC.CO2
  // 27) (AEROSOL.) ACCUMULATION.ORGANIC.HEXANE
  // 28) (AEROSOL.) DUST.ORGANIC.CO2
  // 29) (AEROSOL.) DUST.ORGANIC.HEXANE
