...
project = 'MIAM'
copyright = f'2026-{datetime.datetime.now().year}, University Corporation for Atmospheric Research'
...
html_theme_options = {
    "external_links": [],
    "github_url": "https://github.com/NCAR/miam",
