...
//           const std::string species_key = Join({ name_, scheme.name_, phase.name_, phase_species.species_.name_ });
...
//       const std::string number_key = Join({ name_, scheme.name_, AerosolModel::AEROSOL_MOMENTS_[0] });
...
//       // Find density index
//       const std::string density_key = Join({ name_, scheme.name_, AerosolModel::AEROSOL_MOMENTS_[1] });
...
//       // Find radius index
//       const std::string radius_key = Join({ name_, scheme.name_, AerosolModel::AEROSOL_MOMENTS_[2] });
...
//     const std::string species_key = Join({ name_, scheme.name_, phase.name_, species.name_ });
...
//       const std::string number_key = Join({ name_, scheme.name_, AEROSOL_MOMENTS_[0] });
...
//       const std::string radius_key = Join({ name_, scheme.name_, AEROSOL_MOMENTS_[2] });
